...
export const curses: RollTableData<d100> = [
	...
	},
	{
		roll: 2,
		value:
			'Characters feet always sink at least 1 inch into any surface they walk on (this at least accounts for walking on water, as in if they try to walk on water they sink normally)',
	},
	{
		roll: 3,
	...
	},
	{
		roll: 35,
		value:
			'All food and drink consumed immediately tastes of rotten flesh a successful con save of DC 15 can overcome this taste. ',
	},
	{
		roll: 36,
		value:
	...
	},
	{
		roll: 100,
		value:
			'This curse makes the character forcibly say gibberish every time they cast a spell (or some other common action).',
	},
]
