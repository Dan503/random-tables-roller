...
export let TravelMethod;

(function (TravelMethod) {
  TravelMethod["WALK"] = "Walking";
  TravelMethod["SNOWSHOE"] = "Snow racket shoes";
  TravelMethod["BIRD"] = "Axe Beak";
  TravelMethod["DOG"] = "Dog";
  TravelMethod["DEER"] = "Reindeer";
  TravelMethod["BEAR"] = "Polar bear";
})(TravelMethod || (TravelMethod = {}));

export const travelMethods = ['WALK', 'SNOWSHOE', 'DOG', 'BIRD', 'DEER', 'BEAR'];
export const creatureData = {
  ...
  BEAR: {
    ...
    str: 30,
    // Officially bears have strength of 20 but it made reindeer sleds overpowered at 20 strength
    strMod: 10,
    carryCapacity: generateCarryCapacity({
      strengthScore: 30
    }),
